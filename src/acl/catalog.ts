  ...
  },
  {
    ...
    tabs: [
      ...
      { key: "assistente", label: "Assistente IA", subTabs: [
        ...
        { key: "classificacao", label: "Classificação IA" },
        { key: "relatorios", label: "Relatórios Gerenciais" },
        { key: "conversor", label: "Conversor de Documentos" },
      ]},
      { key: "governanca", label: "Governança ART", subTabs: [
        { key: "executiva", label: "Visão Executiva" },
        { key: "servicos", label: "Relatório Gerencial de Serviços" },
        { key: "art_bloco", label: "ART por Bloco" },
        { key: "relatorio_crea", label: "Relatórios CREA" },
      ]},
