...
export const PixelDeskSprite = ({ kind, width, height }: Props) => {
  ...
  return (
    ...
    >
      ...
      <polygon points="2,12 6,4 30,4 26,12" fill={woodLight} />
      ...
      {kind === "admin" && (
        <>
          ...
          <rect x="11" y="10" width="1" height="1" fill="#0ea5e9" opacity="0.5" />
        </>
      )}
      ...
      {kind === "engenharia" && (
        <>
          ...
          <rect x="8" y="5" width="7" height="5" fill="#e87a1a" opacity="0.8" />
      ...
      {kind === "juridico" && (
        <>
          ...
          <rect x="22" y="4" width="1" height="6" fill="#d97706" />
          <rect x="20" y="5" width="5" height="1" fill="#d97706" />
        </>
      )}
      ...
      {kind === "default" && (
        <>
          ...
          <rect x="12" y="6" width="8" height="4" fill="#5a8acb" />
          {/* Caneca de Café */}
          <rect x="24" y="8" width="3" height="3" fill="#fff" />
          <rect x="25" y="9" width="1" height="1" fill="#6b3a1a" />
        </>
      )}
    </svg>
  );
