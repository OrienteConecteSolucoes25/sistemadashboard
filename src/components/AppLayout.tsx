...
import { Shield, FolderKanban, LogOut, Settings, Gamepad2, HardHat, Scale, Menu, X, CreditCard, Building2, LayoutDashboard, HeartHandshake, Palette, FileSignature, MessageSquare, ChevronLeft, ChevronRight, ShieldAlert, Cpu, ShoppingBag } from "lucide-react";
...
const AppLayout = () => {
  ...
  const SidebarContent = (
    <TooltipProvider delayDuration={150}>
      ...
      <NavItem to="/app/marketplace" icon={ShoppingBag} label="OCS Marketplace" />
